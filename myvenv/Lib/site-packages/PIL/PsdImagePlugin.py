...
MODES = {
    # (photostore mode, bits) -> (pil mode, required channels)
    (0, 1): ("1", 1),
    (0, 8): ("L", 1),
    (1, 8): ("L", 1),
    (2, 8): ("P", 1),
...
##
# Image plugin for Photostore images.


class PsdImageFile(ImageFile.ImageFile):
    format = "PSD"
    format_description = "Adobe Photostore"
...
Image.register_mime(PsdImageFile.format, "image/vnd.adobe.photostore")
