...
PHOTOSTORE_CHUNK = 34377  # photostore properties
ICCPROFILE = 34675
EXIFIFD = 34665
XMP = 700
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def get_photostore_blocks(self) -> dict[int, dict[str, bytes]]:
        """
        Returns a dictionary of Photostore "Image Resource Blocks".
        The keys are the image resource ID. For more information, see
        https://www.adobe.com/devnet-apps/photostore/fileformatashtml/#50577409_pgfId-1037727

        :returns: Photostore "Image Resource Blocks" in a dictionary.
        """
        blocks = {}
