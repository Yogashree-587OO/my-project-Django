...
# 1996-05-05 fl   Workaround Photostore 2.5 CMYK polarity bug
...
def APP(self: JpegImageFile, marker: int) -> None:
    ...
    elif marker == 0xFFED and s[:14] == b"Photostore 3.0\x00":
        # parse the image resource block
        offset = 14
        photostore = self.info.setdefault("photostore", {})
